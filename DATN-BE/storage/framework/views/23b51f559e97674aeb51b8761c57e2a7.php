        ...
        <tbody>
            <?php $__currentLoopData = $orderDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr style="background-color: #f9f9f9;">
                    <td style="border: 1px solid #ddd; padding: 10px;"><?php echo e($item->product->name); ?></td>
                    <td style="border: 1px solid #ddd; padding: 10px;">
                        <?php echo e($item->variant->size->name ?? ''); ?> <?php echo e($item->variant->color->name ?? ''); ?>

                    </td>
                    <td style="border: 1px solid #ddd; padding: 10px;"><?php echo e($item->quantity); ?></td>
                    <td style="border: 1px solid #ddd; padding: 10px;"><?php echo e($item->price); ?> VND</td>
                </tr>
...
<?php /**PATH E:\laragon\www\DATN\DATN-BE\resources\views/emails/mail_order_guest_cart.blade.php ENDPATH**/ ?>