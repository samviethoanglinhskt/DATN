                            ...
                            <div className="p-l-25 p-r-30 p-lr-0-lg">
                                <div className="wrap-slick3 flex-sb flex-w">
                                    ...
                                    <div className="slick3 gallery-lb">
                                        <div className="item-slick3" data-thumb="src/assets/images/product-detail-01.jpg">
                                        ...
                                        <div className="item-slick3" data-thumb="src/assets/images/product-detail-02.jpg">
                                            <div className="wrap-pic-w pos-relative">
                                        ...
                                        <div className="item-slick3" data-thumb="src/assets/images/product-detail-03.jpg">
                                            <div className="wrap-pic-w pos-relative">
